    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Registar novo usuário</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('siape') ? ' has-error' : '' }}">
                            <label for="siape" class="col-md-4 control-label">SIAPE</label>

                            <div class="col-md-6">
                                <input id="siape" type="text" class="form-control" name="siape" value="{{ old('siape') }}" required>
